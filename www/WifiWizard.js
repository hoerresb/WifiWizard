...
var WifiWizard = {
    ...
    /**
     *  Gets the currently connected router ip
     * @param 	win	callback function
     * @param 	fail	callback function if error
     */
    getCurrentRouterIP: function (win, fail) {
      if(typeof win != "function") {
          console.log("getCurrentRouterIP first parameter must be a function to handle IP.");
        return;
      }
      cordova.exec(win, fail, 'WifiWizard', 'getConnectedRouterIP', [])
    },
